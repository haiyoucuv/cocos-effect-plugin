...
public class CocosEffectYamlTextImpl extends ASTWrapperPsiElement implements CocosEffectYamlText {

  public CocosEffectYamlTextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CocosEffectVisitor visitor) {
    visitor.visitYamlText(this);
  }
