...
public class CocosEffectGlslTextImpl extends ASTWrapperPsiElement implements CocosEffectGlslText {

  public CocosEffectGlslTextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CocosEffectVisitor visitor) {
    visitor.visitGlslText(this);
  }
